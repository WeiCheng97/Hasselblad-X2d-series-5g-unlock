...
- **Supported models**: Hasselblad X2D 100C (firmware v4.2.0, tested), X2D II 100C (v1.3.16.2, tested), 907X & CFV 100C (v4.0.0, community-tested; hotspot name looks like `CFV 100C xxxxxx`). Other firmware versions should work identically but are untested.
